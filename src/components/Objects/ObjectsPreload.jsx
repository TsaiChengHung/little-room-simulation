...
const resources = [
    ...
    {
        name:'adele styled room chair set',
        description: 'Adele Styled Room Chair Set, a warm and luxurious tone, creates a sophisticated and elegant atmosphere. Suitable for various styles, it creates a warm and inviting spatial feel.',
        tags: ["chair", "adele", "furniture"],
        price: 300,
        modelFileGLB: '/objects/Adele Styled Room Chair Set-t.glb',
        thumbnailUrl: '/objects/thumbnails/Adele Styled Room Chair Set_thumbnail.png',
    },
    {
    ...
    {
        name:'eileen 4-foot entryway modular shoe cabinet set',
        description: 'Eileen 4-Foot Entryway Modular Shoe Cabinet Set, a warm and luxurious tone, creates a sophisticated and elegant atmosphere. Suitable for various styles, it creates a warm and inviting spatial feel.',
        tags: ["cabinet", "eileen", "furniture"],
        price: 300,
        modelFileGLB: '/objects/Eileen 4-Foot Entryway Modular Shoe Cabinet Set-t.glb',
        thumbnailUrl: '/objects/thumbnails/Eileen 4-Foot Entryway Modular Shoe Cabinet Set_thumbnail.png',
    },
    {
    ...
    {
        name:'nara sofa',
        description: 'Nara Sofa, a contemporary and comfortable seating solution with clean lines and plush cushioning. Features elegant design with durable upholstery, perfect for modern living spaces.',
        tags: ["sofa", "seating", "furniture", "nara"],
        price: 800,
        modelFileGLB: '/objects/Nara Sofa-t.glb',
        thumbnailUrl: '/objects/thumbnails/Nara Sofa_thumbnail.png',
    },
    {
        name:'puffy sofa',
